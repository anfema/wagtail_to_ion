# Generated by Django 3.0.11 on 2021-01-05 20:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    "UPDATE django_content_type SET app_label='test_app', model='ioncollection'"
                    "  WHERE app_label='wagtail_to_ion' AND model='collection'"
                ),
            ],
        ),
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    "UPDATE django_content_type SET app_label='test_app', model='iondocument'"
                    "  WHERE app_label='wagtail_to_ion' AND model='iondocument'"
                ),
            ],
        ),
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    "UPDATE django_content_type SET app_label='test_app', model='ionimage'"
                    "  WHERE app_label='wagtail_to_ion' AND model='ionimage'"
                ),
            ],
        ),
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    "UPDATE django_content_type SET app_label='test_app', model='ionlanguage'"
                    "  WHERE app_label='wagtail_to_ion' AND model='language'"
                ),
            ],
        ),
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    "UPDATE django_content_type SET app_label='test_app', model='ionmedia'"
                    "  WHERE app_label='wagtail_to_ion' AND model='ionmedia'"
                ),
            ],
        ),
        migrations.SeparateDatabaseAndState(
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('content_type', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT,
            ...
            database_operations=[
                migrations.RunSQL(
                    "UPDATE django_content_type SET app_label='test_app', model='contenttypedescription'"
                    "  WHERE app_label='wagtail_to_ion' AND model='contenttypedescription'"
                ),
            ],
        ),
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    "UPDATE django_content_type SET app_label='test_app', model='ionrendition'"
                    "  WHERE app_label='wagtail_to_ion' AND model='ionrendition'"
                ),
            ],
        ),
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    "UPDATE django_content_type SET app_label='test_app', model='ionmediarendition'"
                    "  WHERE app_label='wagtail_to_ion' AND model='ionmediarendition'"
                ),
            ],
        ),
        migrations.CreateModel(
